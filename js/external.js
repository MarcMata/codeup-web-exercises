...
//
// let confirmHours = confirm(`You worked ${amazonHours} hours for Amazon, ${googleHours} hours for Google, and ${facebookHours} hours for facebook?
...
//
// let canEnroll = !scheduleConflicts && parseInt(currentClassSize) < parseFloat(maxClassSize);
//
...
let canOfferApply = (premiumMember || (parseInt(cartSize) >= minCartSize) && !offerExpired);
alert(`For your product offer to work you need to have a ${minCartSize} items in your cart. You have ${cartSize}`);
